L0:     PUSH         1         ; Declaring INT a
        ...
        LOADL        5
        STORE(1)     6[SB]     ; Assigning constant x
        ...
        LOADL        5
        STORE(1)     12[SB]    ; Assigning j
        LOAD(1)      12[SB]    ; Loading j
        LOAD(1)      11[SB]    ; Loading i
...
L2:     STORE(1)     10[SB]    ; Assigning k
        ...
        LOADL        1         ; True Boolean
        STORE(1)     10[SB]    ; Assigning k
L3:     LOAD(1)      10[SB]    ; Loading k
        LOADL        1         ; True Boolean
        LOADL        1
        CALL         eq
        ...
        LOADL        1
        CALL         add       ; Adition
        STORE(1)     13[SB]    ; Assigning temp
        LOAD(1)      13[SB]    ; Loading temp
...
L5:     LOAD(1)      10[SB]    ; Loading k
        LOADL        1         ; True Boolean
        LOADL        1
        CALL         eq
        JUMPIF(0)    L6[CB]    ; If (jump to else)
        LOADA(1)     10[SB]    ; Loading address of k
        ...
        LOAD(1)      10[SB]    ; Loading k for next expression
        JUMP         L7[CB]    ; Else (jump over else)
L6:     LOADL        1         ; True Boolean
L7:     STORE(1)     10[SB]    ; Assigning k
        PUSH         1         ; Declaring INT a
        LOADA(1)     14[SB]    ; Loading address of a
        LOADL        69        ; Loading character
        CALL         put       ; Print character
        LOADL        110       ; Loading character
        CALL         put       ; Print character
        ...
        LOAD(1)      14[SB]    ; Loading a for next expression
        CALL         putint    ; Print int
        CALL         puteol
        POP(0)       15
        HALT                   ; Generated by the Noot Compiler (2013/07/09 11:11)
